...
\bibitem{Biggs}
Biggs, M. C. \emph{Constrained minimization using recursive quadratic programming.} Towards global optimization (1975).

\bibitem{Betts}
Betts, John T. \emph{Practical methods for optimal control and estimation using nonlinear programming}. Society for Industrial and Applied Mathematics, 2010.

\bibitem{powell-conv}
Powell, Michael JD. \emph{The convergence of variable metric methods for nonlinearly constrained optimization calculations.} Nonlinear programming 3. 1978. 27-63.

\bibitem{powell-fast}
Powell, Michael JD. \emph{A fast algorithm for nonlinearly constrained optimization calculations.} Numerical analysis. Springer, Berlin, Heidelberg, 1978. 144-157.
